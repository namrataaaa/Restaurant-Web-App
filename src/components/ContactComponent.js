...
import { Breadcrumb, BreadcrumbItem, Button, Label, Col, Row, Input } from 'reactstrap';
...
class Contact extends Component {
    ...
    constructor(props) {
        ...
        // this.state = {
        //     firstname: '', lastname: '', telnum: '', email: '', agree: false, contactType: 'Tel. ',message: '',
        //     touched: { firstname: false, lastname: false, telnum: false, email: false }
        // }
                        ...
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    className="form-control" 
                                    validators={{
                                        required, isNumber, minLength: minLength(3), maxLength: maxLength(10)
                                    }}/>
                                    <Errors
                                        className="text-danger"
                                        model=".telnum"
